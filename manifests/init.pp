...
class epel (
  ...
  Boolean $epel_testing_managed                        = false,
  ...
  Boolean $epel_source_managed                         = false,
  ...
  Boolean $epel_debuginfo_managed                      = false,
  ...
  Boolean $epel_testing_source_managed                 = false,
  ...
  Boolean $epel_testing_debuginfo_managed              = false,
  ...
  Boolean $epel_gpg_managed                            = false,
